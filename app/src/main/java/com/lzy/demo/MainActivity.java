...
public class MainActivity extends BaseActivity {
    ...
    public void fab(View view) {
        WebActivity.runActivity(this, "我的Github,欢迎star", "https://github.com/18511084155");
    }
    ...
    private void initData() {
        ...
        model3.title = "";
        model3.des = "下面是OkHttpUtils包的使用方法";
        model3.type = 1;
        items.add(model3);

        OkHttpModel model4 = new OkHttpModel();
        model4.title = "基本功能(OkHttpUtils)";
        ...
        model8.des = "1.OkHttpUtils的强大的缓存功能,让你代码无需关心数据来源,专注于业务逻辑的实现\n" +
                     "2.共有五种缓存模式满足你各种使用场景\n" +
                     "3.支持自定义缓存过期时间";
        model8.type = 0;
        items.add(model8);
        ...
        model9.title = "";
        model9.des = "下面是okhttpserver包的使用方法";
        model9.type = 1;
        items.add(model9);

        OkHttpModel model10 = new OkHttpModel();
        model10.title = "下载管理(okhttpserver)";
        model10.des = "1.这个属于okhttpserver依赖中的功能,并不属于OkHttpUtils\n" +
        ...
        model11.title = "上传管理(okhttpserver)";
        model11.des = "1.这个同上,也属于okhttpserver依赖中的功能\n" +
